...
class OController
{
    private string $domain = "o.rprp.nlnetlabs.net";
    ...
    function __construct() {
        ...
        preg_match('/o(\d*)-([^.]+)\./', $this->domain, $matches);
        if ($matches[1]) {
...
//        $xml->startElement("publish");
//        $xml->writeAttribute("uri", "rsync://$this->domain/repository/koenvh.cer");
//        $xml->writeAttribute("hash", hash("sha256", $openSSL->retrieveCertificate($newDomain)));
//        $xml->writeRaw(base64_encode($openSSL->retrieveCertificate($newDomain)));
//        $xml->endElement();
//
//        $xml->startElement("publish");
//        $xml->writeAttribute("uri", "rsync://$this->domain/repository/koenvh.crl");
//        $xml->writeAttribute("hash", hash("sha256", base64_decode($openSSL->retrieveCrl($this->domain))));
//        $xml->writeRaw($openSSL->retrieveCrl($this->domain));
//        $xml->endElement();
//
//        $xml->startElement("publish");
//        $xml->writeAttribute("uri", "rsync://$this->domain/repository/koenvh.mft");
//        $xml->writeAttribute("hash", hash("sha256", base64_decode($manifest)));
//        $xml->writeRaw($manifest);
//        $xml->endElement();
